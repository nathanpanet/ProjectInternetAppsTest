...
namespace ProjectInternetAppsTest.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Price,Description,Discount,Img")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Price,Description,Discount,Img")] Product product)
        {
            if (id != product.ID)
            {
                return NotFound();
